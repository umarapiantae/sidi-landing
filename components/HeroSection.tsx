const HeroSection = () => {
  return (
    <section
      ...
      style={{
        backgroundImage:
          "url('https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgRtN431P2zjoHQDSo-lxXDK1EVJQ8xfQ4PbCLo7cTB00WeRlSSURX-Qdp3-rsxfNwnC9vCxWq-5lxeNZmT9hRYyEJkZ0nF7mGqZf_AHmmWbYOhzb8uDFUip1xQKGUgtcTPDpxshIy9N9Ao3GwEjWd-fGQoyaVblR3IrRPWkvLqCGbjNUZPCkRpel9P2kg')",
      }}
    >
      <img
        ...
        alt="Logo SiDi"
      />
      <div className="text-[#f2cc30] text-[17px] font-light mb-2">Selamat datang di</div>
      <h1 className="text-[50px] md:text-[80px] font-light w-full md:w-[500px] mb-6">Sistem Digitalisasi</h1>
      <p className="text-lg font-light w-full md:w-[500px] mb-10 text-[#f0eeee]">
        Merancang dan mengembangkan struktur dasar dokumen, aplikasi, dan desain dalam format digital. Lihat produk digital kami{' '}
        <a href="#" className="text-blue-700 hover:underline">disini!</a>
      </p>
